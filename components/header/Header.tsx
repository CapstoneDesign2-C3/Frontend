      ...
      <nav>
        <ul>
          <li className="flex space-x-10 px-6 py-3">
            ...
            <a href="/camera" className="text-black hover:text-blue-400 font-semibold">Video</a>
            <a href="/video" className="text-black hover:text-blue-400 font-semibold">Camera</a>
